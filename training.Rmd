...
Before jumping into analysis, I want to quickly do a refresher on some basic statistics concepts that I'm going to be mentioning throughout today and make sure everyone's on the same page.
...
For now, I will show you how I use one particularly flexible tool called Maaslin2 to analyze the data we're working with today. I'm still interested in the comparison of countries, and want to know what specific taxa are enriched in the forehead samples in the USA vs Mexico. 
...
However, its power lies in the ability to add annotations. Below, I add color and Genus-level labels to the significant taxa (separating them from the non-significant taxa which remain grey). You can get as pretty and technical as your heart desires with this plot.
